...
const Form: React.FC = () => {
  ...
  const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      preferences: checked
        ? [...prevData.preferences, name]
        : prevData.preferences.filter((item) => item !== name),
    }));
  };
          ...
          <div className={styles.checkBoxContainer}>
            ...
            <div className={styles.checkboxWrapper}>
              <Checkbox
                ...
                id={"8"}
                name={"veg"}
                checked={formData.preferences.includes("veg")}
                label={"Veg"}
                value=""
              ...
              <Checkbox
                ...
                id={"9"}
                name={"nonveg"}
                checked={formData.preferences.includes("nonveg")}
                label={"Non-Veg"}
                value=""
                onChange={handleCheckboxChange}
              />
